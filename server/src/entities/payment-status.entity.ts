 ...
 * @version 1.0.0
 * @since 15-JAN-2026
 * @filename payment-status.entity.ts
 * @file Payment Status Entity Definition using TypeORM and TypeGraphQL
 */
...
@ObjectType()
@Entity()
export class PaymentStatus extends BaseEntity { // BaseEntity provides static methods like .find(), .save() etc.
