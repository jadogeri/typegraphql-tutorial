 ...
 * @file Category Entity Definition using TypeORM and TypeGraphQL
 */
...
@ObjectType()
@Entity()
export class Category extends BaseEntity { // BaseEntity provides static methods like .find(), .save() etc.
