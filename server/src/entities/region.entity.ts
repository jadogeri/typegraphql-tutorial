 ...
 * @version 1.0.0
 * @since 14-JAN-2026
 * @filename region.entity.ts
 * @file Region Entity Definition using TypeORM and TypeGraphQL
 */
...
@ObjectType()
@Entity()
export class Region extends BaseEntity { // BaseEntity provides static methods like .find(), .save() etc.
